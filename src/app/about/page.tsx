import { Avatar, Button, Flex, Heading, Icon, IconButton, SmartImage, Tag, Text, RevealFx, LetterFx } from '@/once-ui/components';
                                        ...
                                        <Flex
                                            ...
                                            {experience.images.length > 0 && (
                                                <Flex
                                                    ...
                                                    wrap>
                                                    {experience.images.map((image : { alt: string; src: string , width:number, height: number}, index) => (
                                                        <Flex
                                                            key={index}
                                        ...
                                        <Flex
                                            ...
                                            {skill.images.length > 0 && (
                                                <Flex
                                                    ...
                                                    wrap>
                                                    {skill.images.map((image : { alt: string; src: string , width:number, height: number}, index) => (
                                                        <Flex
                                                            key={index}
                                                            border="neutral-medium"
                                                            borderStyle="solid-1"
